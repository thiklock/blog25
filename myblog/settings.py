...
SECRET_KEY = 'django-insecure-3*t33$$_y8+d8=1o7fx+20a97$_e=w)0k^!1&hjx49r%04l0ne'
...
LOGGING = {
    ...
    'loggers': {
        'blog.templatetags.random_image': { # Match the logger name
            'handlers': ['console'],
            'level': 'INFO',
            'propagate': False,
        },
